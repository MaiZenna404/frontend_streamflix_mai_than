export const quizQuestions = [
  ...
  },
  {
    id: 3,
    question:
      "Dans quel film trouve-t-on la réplique culte 'May the Force be with you' ?",
  ...
  },
  {
    id: 5,
    question:
      "Quel est le film d'animation le plus rentable de tous les temps ?",
    options: [
      "Le Roi Lion (2019)",
  ...
  },
  {
    id: 7,
    question:
      "Quel réalisateur est connu pour ses films 'Pulp Fiction' et 'Kill Bill' ?",
    options: [
      "Martin Scorsese",
      "Quentin Tarantino",
      "David Fincher",
  ...
  },
  {
    id: 8,
    question:
      "Dans 'Le Seigneur des Anneaux', qui doit détruire l'anneau unique ?",
  ...
  },
  {
    id: 9,
    question:
      "Quel acteur joue le rôle de Jack Sparrow dans 'Pirates des Caraïbes' ?",
